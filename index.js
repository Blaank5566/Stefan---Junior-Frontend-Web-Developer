...
const elements = {
  ...
  p5Desc: document.getElementById("p5Desc"),
  p5Title: document.getElementById("p5Title"),
...
const translations = {
  en: {
    ...
    p4Title:"Drum Kit",
    p5Desc: "An automated network orchestration toolchain written in Python 3. This system allows developers to safely scan for local Wi-Fi architectures and inject network configurations into a headless Raspberry Pi (Linux) using a remote Bluetooth client terminal.</p>",
    p5Title: "IoT Device Provisioning via Bluetooth Serial (RFCOMM)",
    p1Live: "Live",
    p1Github: "GitHub",
    p2Live: "Live",
    p2Github: "Itch.io",
  ...
  de: {
    ...
    p4Title:"Schlagzeug",
    p5Desc: "Eine in Python 3 geschriebene Toolchain zur automatisierten Netzwerkorchestrierung. Dieses System ermöglicht es Entwicklern, sicher nach lokalen WLAN-Architekturen zu suchen und Netzwerkkonfigurationen über ein entferntes Bluetooth-Client-Terminal in einen headless Raspberry Pi (Linux) einzuspielen.",
    p5Title: "Bereitstellung von IoT-Geräten über serielle Bluetooth-Verbindung (RFCOMM)",
    p1Live: "Live",
    p1Github: "GitHub",
    p2Live: "Live",
    p2Github: "Itch.io",
